  ...
  return (
    <>
      <div
        ...
        style={{
          height: "100%",
          backgroundImage: `url(https://images.unsplash.com/photo-1709315957145-a4bad1feef28?q=80&w=1976&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`,
        ...
        <div className="mx-auto max-w-7xl px-2 md:px-4">
          <div>
            <div className="flex flex-col space-y-8 pb-10 pt-12 text-center md:pt-24">
              ...
              <p className="mx-auto max-w-3xl text-base text-white md:text-xl">
                Revitalize your fitness routine and sculpt your dream physique
                with our cutting-edge gym membership plans. <br /> Join us today
                and embark on a journey to a healthier, stronger you!
              </p>
            </div>
                ...
                <div className="hover:border-blue-800  hover:scale-110 transform transition hover:bg-gray-400 duration-500  rounded-3xl border  border-gray-200 bg-white shadow">
                  <div className="flex w-full flex-col justify-start space-y-4 px-8 pt-10">
                    ...
                    <div className="flex w-full flex-col items-start justify-start space-y-1">
                      <p className="w-full text-xl font-semibold leading-loose text-black">
                        Warrior plan
                      </p>
                      <p className="w-full text-base leading-normal text-gray-600">
                        Billed annually (Incl GST)
                      </p>
                    </div>
                  </div>
                  <div className="flex w-full flex-col items-start justify-start px-8 pb-10 pt-8">
                    <div className="flex w-full flex-col space-y-4">
                      ...
                      <div className="inline-flex w-full space-x-3">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Free of charge diet plan for 1 month
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Unlimited Wifi at no extra cost
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Free Gym consultation at no extra cost
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                  ...
                  <div className="flex w-full flex-col items-start justify-start px-8 pb-10 pt-8">
                    <div className="flex w-full flex-col space-y-4">
                      ...
                      <div className="inline-flex w-full space-x-3">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Premium Diet plan including Recipes
                        </p>
                      </div>
                      ...
                      <div className="inline-flex w-full space-x-3">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Personal Training at group basis
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Detailed progress report and consultation
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Free Zumba classes 2 sessions a week
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex w-full flex-col items-start justify-start px-8 pb-10 pt-8">
                    <div className="flex w-full flex-col space-y-4">
                      ...
                      <div className="inline-flex w-full space-x-3">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Certified personal gym trainer
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                      ...
                      <div className="inline-flex w-full space-x-3">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Free snacks and coffee at cafe
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Access to yoga sessions and meditation
                        </p>
                      </div>
                      <div className="inline-flex w-full space-x-3">
                        <div className="flex items-center justify-center rounded-full bg-gray-100 p-1">
                        ...
                        <p className="w-full text-base leading-normal text-gray-600">
                          Free MuscleTech's Whey Isolate scoop
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-14 space-y-16 py-12 opacity-100  ">
              <div>
                <div className="">
                ...
                <div className="grid md:grid-cols-3 md:space-x-8">
                  <div className="my-8 space-y-5">
                    <div className="flex w-full flex-col space-y-2">
                      ...
                      <p className="w-full text-base leading-normal text-gray-200">
                  ...
                  <div className="my-8 space-y-5">
                    <div className="flex w-full flex-col space-y-2">
                      ...
                      <p className="w-full text-base leading-normal text-gray-200">
                        Of course. Our pricing scales with your company. Chat to
                        our friendly team to find a solution that works for you.
                      </p>
                    </div>
                  </div>
                  <div className="my-8 space-y-5">
                    <div className="flex w-full flex-col space-y-2">
                      ...
                      <p className="w-full text-base leading-normal text-gray-200">
                        We understand that things change. You can cancel your
                        plan at any time and we’ll refund you the difference
                        already paid.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="my-8 space-y-5">
                    <div className="flex w-full flex-col space-y-2">
                      ...
                      <p className="w-full text-base leading-normal text-gray-200">
                        ...
                        upgrade one workspace, and still have any number of free
                        workspaces.
                      </p>
                    </div>
                  </div>
                  <div className="my-8 space-y-5">
                    <div className="flex w-full flex-col space-y-2">
                      ...
                      <p className="w-full text-base leading-normal text-gray-200">
                        ...
                        account by going to account from a laptop or desktop.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-10">
                  <div className="flex flex-col justify-between rounded-md bg-gray-50 p-4 md:flex-row md:items-center md:p-8 lg:space-x-8">
                    ...
                    <button
                      type="button"
                      className="mt-4 hover:scale-110 transform transition rounded-md bg-black px-3 py5 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black md:mt-0"
                    >
                      Get in Touch
                    </button>
                  </div>
