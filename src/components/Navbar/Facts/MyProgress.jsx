...
function MyProgress() {
  return (
    <div
      style={{
        backgroundImage: `url(https://images.unsplash.com/photo-1576678927484-cc907957088c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGZpdG5lc3N8ZW58MHx8MHx8fDA%3D)`,
    ...
    >
      <div className="max-w-[85rem] hover:bg-gray-800  rounded-xl m-4 p-4">
        <h1 className="text-3xl font-bold text-center m-4 text-white">
          My Workout Progress
        </h1>
        <div className="grid grid-cols-2 px-2 sm:grid-cols-4 gap-2  ">
